    ...
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
		...
		<Image
			...
			className="relative rounded-full mx-auto object-cover
				w-32 h-32 sm:w-40 sm:h-40 md:w-44 md:h-44 xl:w-48 xl:h-48"
		...
		<div className="z-20 max-w-5xl mx-auto">
			<h2 className="text-xs sm:text-sm md:text-base uppercase text-gray-500 pb-2 tracking-[0.3em] sm:tracking-[0.4em] font-['Electrolize']">
			{pageInfo?.role}
			</h2>
			<h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-semibold px-4 sm:px-10 font-['Electrolize']">
			<span className="mr-3">{text}</span>
			<Cursor cursorColor="#F7AB0A" />
			</h1>

			{/* Navigation Buttons - Redesigned */}
			<div className="pt-8 flex flex-wrap justify-center gap-3 sm:gap-4">
				<Link href="#about">
					<button className="group px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg
						bg-white/5 hover:bg-white/10
						border border-white/20 hover:border-[#61BAAD]/60
						text-white/80 hover:text-white
						font-['Electrolize'] uppercase text-sm tracking-widest
			...
			{/* CV Download Button - Separated and cohesive */}
			<div className="pt-6">
				<a
					href="LeandroFiadone-FrontEnd-CV.pdf"
					download="LeandroFiadone-FrontEnd-CV.pdf">
					<button className="group px-8 sm:px-10 py-3 sm:py-3.5 rounded-lg
