	...
	return (
		<article
			className="group flex flex-col
				w-[340px] md:w-[400px] lg:w-[440px] xl:w-[480px] 2xl:w-[540px]
				h-[440px] md:h-[460px] lg:h-[470px] xl:h-[465px] 2xl:h-[490px]
				flex-shrink-0
				snap-center
				bg-[#1a1a1a]
			...
			<a
				...
				target="_blank"
				onClick={handleClick}
				className="w-full h-[190px] md:h-[200px] lg:h-[205px] xl:h-[205px] 2xl:h-[215px] group/image relative block flex-shrink-0 overflow-hidden"
			>
				<MotionDiv
			...
			{/* Project Info */}
			<div className="w-full flex-1 flex flex-col px-4 py-2.5 md:px-5 md:py-3 overflow-hidden">
				{/* Title & Date */}
				<div className="space-y-1 md:space-y-1.5 flex-shrink-0">
					...
					>
						<h4 className="text-lg md:text-xl font-bold font-['Electrolize']
							text-white/90 group-hover/title:text-white
							transition-all duration-300 flex items-center gap-2 leading-tight line-clamp-1">
				...
				<p className="text-sm text-gray-400/90 leading-relaxed line-clamp-3 mt-2 mb-2.5 md:mb-3">
					{project?.summary}
				</p>

				{/* Bottom Section - Always at bottom */}
				<div className="mt-auto space-y-1.5 md:space-y-2 flex-shrink-0">
					{/* Tech Stack */}
					<div className="space-y-1.5 md:space-y-2">
						<p className="text-xs text-gray-500 uppercase tracking-wider font-['Electrolize']">Technologies</p>
						<div className="flex flex-wrap items-center gap-2">
							{project.techUsed.slice(0, 4).map((tech) => (
								<div key={tech._id} className="group/tech">
									<div className="flex items-center gap-1.5 px-2 py-1 rounded-md
										...
										/>
										<span className="text-xs text-gray-400 group-hover/tech:text-gray-200
							...
							{project.techUsed.length > 4 && (
								<span className="text-xs text-gray-500 font-medium">+{project.techUsed.length - 4}</span>
							)}
						</div>
					</div>

					{/* Action Buttons */}
					<div className="flex items-center gap-2 md:gap-2.5 pt-1.5 md:pt-2 border-t border-white/5">
					<a
						href={project?.nameLink}
						rel="noopener noreferrer"
						target="_blank"
						onClick={handleClick}
						className="flex-1 group/btn px-3 py-1.5 rounded-lg
							bg-[#61BAAD]/10 hover:bg-[#61BAAD]/20
							border border-[#61BAAD]/30 hover:border-[#61BAAD]/60
							text-white/80 hover:text-white
							font-['Electrolize'] uppercase text-xs tracking-wider
							transition-all duration-300 ease-out
					...
					>
						<svg className="w-4 h-4 text-white/60 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
